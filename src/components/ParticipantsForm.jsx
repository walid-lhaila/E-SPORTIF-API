...
const ParticipantsForm = ({onclose, preventClick}) => {
    return  (
                ...
                <div onClick={preventClick}
                    ...
                    <form className="w-[100%]">
                        ...
                        <div className="w-[40%]">
                                ...
                                <input placeholder="" name="fullName" className="block w-full text-md py-2.5 px-3 border border-gray-900 rounded cursor-pointer  placeholder:text-gray-400"
                                       type="text"/>
                            </div>
                        <div className="w-[40%]">
                                <label className="block mb-2 text-sm font-medium text-black font-serif"
                                       htmlFor="file_input">Phone Number</label>
                                <input name="phoneNumber" className="block w-full text-md py-2.5 px-3 border border-gray-900 rounded cursor-pointer  placeholder:text-gray-400"
                                       type="number"/>
                            </div>
                        </div>
                        ...
                        <div className="w-[82%] mx-auto py-2">
                                ...
                                <input placeholder="" name="email" className="block w-full text-md py-2.5 px-3 border border-gray-900 rounded cursor-pointer  placeholder:text-gray-400"
                                       type="text"/>
                        </div>
