            ...
            <div className='bg-fixed' style={{ backgroundImage: `url(${background1})`, backgroundSize: 'cover', backgroundPosition: 'center', height: '840px' }}>
                <div className='flex justify-betweeen items-center w-[90%] mx-auto pt-16'>
                    <div className='w-[50%] pt-5'>
                        ...
                        <div className="py-10">
                            <button className="text-white font-medium bg-gradient-to-r from-blue-900 via-blue-600 to-blue-500 hover:bg-gradient-to-l from-blue-500 via-blue-600 to-blue-900 duration-300 px-20 py-4 rounded text-xl font-serif">
                                Create Event
                            </button>
                        </div>
                    </div>
